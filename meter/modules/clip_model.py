...
class ResidualAttentionBlock(nn.Module):
    ...
    def save_attention_map(self, attn_output_weights):
    ...
    def attention(self, x: torch.Tensor, x_mask: torch.Tensor):
        ...
        self.attn_output_weights = attn_weights

        # Hook to store gradients of attention
        attn_output.register_hook(self.save_attn_gradients)
